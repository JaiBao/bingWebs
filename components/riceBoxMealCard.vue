      ...
      listItems: [
        {
          ...
          // span: '6擇1',
          items: [{ text: '招牌米香油飯盒', name: '雙份油飯', image: '/delicious/2-pic-17.png', product_option_value_id: 1739 }]
        },
        {
          title: '加購湯飲品',
          id: 2,
          product_option_id: 163, //飲料ID
          price: 15,
          name: '飲料',
          span: '+$15',
          // 沒有備註的項目可以只有text字段
          items: [
            { text: '微甜豆漿', name: '微豆', product_option_value_id: 1733 },
            { text: '無糖豆漿', name: '無豆', product_option_value_id: 1734 },
            { text: '古早味紅茶', name: '紅茶', product_option_value_id: 1735 },
            { text: '古早味奶茶', name: '奶茶', product_option_value_id: 1736 },
            { text: '季節甜品', name: '甜湯', product_option_value_id: 1738 },
            { text: '季節濃湯', note: '', name: '濃湯', product_option_value_id: 1737 }
          ]
        }
      ]
    }
      ...
      listItems: [
        {
          ...
          name: '主餐',
          id: 1,
          product_option_id: 165, //主餐ID
          // span: '6擇1',
          items: [{ text: '清蒸嫩雞胸油飯盒', name: '雙份油飯', image: '/delicious/2-pic-18.png', product_option_value_id: 1740 }]
        },
        {
          title: '加購湯飲品',
          id: 2,
          product_option_id: 166, //飲料ID
          price: 15,
          name: '飲料',
          span: '+$15',
          // 沒有備註的項目可以只有text字段
          items: [
            { text: '微甜豆漿', name: '微豆', product_option_value_id: 1741 },
            { text: '無糖豆漿', name: '無豆', product_option_value_id: 1742 },
            { text: '古早味紅茶', name: '紅茶', product_option_value_id: 1743 },
            { text: '古早味奶茶', name: '奶茶', product_option_value_id: 1744 },
            { text: '季節甜品', name: '甜湯', product_option_value_id: 1746 },
            { text: '季節濃湯', note: '', name: '濃湯', product_option_value_id: 1745 }
          ]
        }
      ]
    }
      ...
      listItems: [
        {
          ...
          // span: '6擇1',
          items: [{ text: '傳香滷雞腿油飯盒', name: '雙份油飯', image: '/delicious/2-pic-19.png', product_option_value_id: 1747 }]
        },
        {
          title: '加購湯飲品',
          id: 2,
      ...
      listItems: [
        {
          ...
          // span: '6擇1',
          items: [{ text: '家常厚滷牛油飯盒', name: '雙份油飯', image: '/delicious/2-pic-21.png', product_option_value_id: 1754 }]
        },
        {
          title: '加購湯飲品',
          id: 2,
      ...
      listItems: [
        {
          ...
          name: '主餐',
          id: 1,
          product_option_id: 171, //主餐ID
          // span: '6擇1',
          items: [{ text: '燻鮭魚馬鈴薯油飯盒', name: '雙份油飯', image: '/delicious/2-pic-22.png', product_option_value_id: 1761 }]
        },
        {
          title: '加購湯飲品',
          id: 2,
          product_option_id: 172, //飲料ID
          price: 15,
          name: '飲料',
          span: '+$15',
          // 沒有備註的項目可以只有text字段
          items: [
            { text: '微甜豆漿', name: '微豆', product_option_value_id: 1762 },
            { text: '無糖豆漿', name: '無豆', product_option_value_id: 1763 },
            { text: '古早味紅茶', name: '紅茶', product_option_value_id: 1764 },
            { text: '古早味奶茶', name: '奶茶', product_option_value_id: 1765 },
            { text: '季節甜品', name: '甜湯', product_option_value_id: 1767 },
            { text: '季節濃湯', note: '', name: '濃湯', product_option_value_id: 1766 }
          ]
        }
      ]
    }
      ...
      listItems: [
        {
          ...
          name: '主餐',
          id: 1,
          product_option_id: 173, //主餐ID
          // span: '6擇1',
          items: [{ text: '法式紅酒牛肉丸油飯盒', name: '雙份油飯', image: '/delicious/2-pic-23.png', product_option_value_id: 1768 }]
        },
        {
          title: '加購湯飲品',
          id: 2,
          product_option_id: 174, //飲料ID
          price: 15,
          name: '飲料',
          span: '+$15',
          // 沒有備註的項目可以只有text字段
          items: [
            { text: '微甜豆漿', name: '微豆', product_option_value_id: 1769 },
            { text: '無糖豆漿', name: '無豆', product_option_value_id: 1770 },
            { text: '古早味紅茶', name: '紅茶', product_option_value_id: 1771 },
            { text: '古早味奶茶', name: '奶茶', product_option_value_id: 1772 },
            { text: '季節甜品', name: '甜湯', product_option_value_id: 1774 },
            { text: '季節濃湯', note: '', name: '濃湯', product_option_value_id: 1773 }
          ]
        }
      ]
    }
