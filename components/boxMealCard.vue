      ...
      listItems: [
        {
          ...
          spans: '6擇1',
          items: [
            { text: '薯泥香素鬆潤餅', note: '蛋奶素', name: '薯泥潤餅3吋', image: '/delicious/2-pic-11.png', product_option_value_id: 102 },
            { text: '千島香酥蝦潤餅', name: '炸蝦潤餅3吋', image: '/delicious/2-pic-12.png', product_option_value_id: 103 },
            { text: '蜂蜜芥末雞潤餅', note: '微辣', name: '炒雞潤餅3吋', image: '/delicious/2-pic-13.png', product_option_value_id: 104 },
            { text: '蒜味鄉村魚潤餅', name: '酥魚潤餅3吋', image: '/delicious/2-pic-14.png', product_option_value_id: 105 },
            { text: '凱薩烤培根潤餅', name: '培根潤餅3吋', image: '/delicious/2-pic-15.png', product_option_value_id: 106 },
            { text: '媽手老滷肉潤餅', note: '預訂供應', name: '滷肉潤餅3吋', image: '/delicious/2-pic-16.png', product_option_value_id: 107 }
          ]
        },
        {
          title: '湯飲品',
          ...
          // 沒有備註的項目可以只有text字段
          items: [
            { text: '微甜豆漿', name: '微豆', product_option_value_id: 108 },
            { text: '無糖豆漿', name: '無豆', product_option_value_id: 109 },
            { text: '古早味紅茶', name: '紅茶', product_option_value_id: 110 },
            { text: '古早味奶茶', name: '奶茶', product_option_value_id: 111 },
            { text: '季節甜品', note: '(限時升等豆花甜品)', name: '甜湯', product_option_value_id: 113 },
            { text: '季節濃湯', note: '', name: '濃湯', product_option_value_id: 112 }
          ]
        }
      ]
    }
      ...
      listItems: [
        {
          ...
          spans: '6擇1',
          items: [
            { text: '薯泥香素鬆潤餅', note: '蛋奶素', name: '薯泥潤餅3吋', image: '/delicious/2-pic-11.png', product_option_value_id: 120 },
            { text: '千島香酥蝦潤餅', name: '炸蝦潤餅3吋', image: '/delicious/2-pic-12.png', product_option_value_id: 121 },
            { text: '蜂蜜芥末雞潤餅', note: '微辣', name: '炒雞潤餅3吋', image: '/delicious/2-pic-13.png', product_option_value_id: 122 },
            { text: '蒜味鄉村魚潤餅', name: '酥魚潤餅3吋', image: '/delicious/2-pic-14.png', product_option_value_id: 123 },
            { text: '凱薩烤培根潤餅', name: '培根潤餅3吋', image: '/delicious/2-pic-15.png', product_option_value_id: 124 },
            { text: '媽手老滷肉潤餅', note: '預訂供應', name: '滷肉潤餅3吋', image: '/delicious/2-pic-16.png', product_option_value_id: 125 }
          ]
        },
        {
          title: '湯飲品',
          ...
          // 沒有備註的項目可以只有text字段
          items: [
            { text: '微甜豆漿', name: '微豆', product_option_value_id: 126 },
            { text: '無糖豆漿', name: '無豆', product_option_value_id: 127 },
            { text: '古早味紅茶', name: '紅茶', product_option_value_id: 128 },
            { text: '古早味奶茶', name: '奶茶', product_option_value_id: 129 },
            { text: '季節甜品', note: '(限時升等豆花甜品)', name: '甜湯', product_option_value_id: 131 },
            { text: '季節濃湯', note: '', name: '濃湯', product_option_value_id: 130 }
          ]
        }
      ]
    }
      ...
      listItems: [
        {
          ...
          spans: '6擇1',
          items: [
            { text: '薯泥香素鬆潤餅', note: '蛋奶素', name: '薯泥潤餅3吋', image: '/delicious/2-pic-11.png', product_option_value_id: 138 },
            { text: '千島香酥蝦潤餅', name: '炸蝦潤餅3吋', image: '/delicious/2-pic-12.png', product_option_value_id: 139 },
            { text: '蜂蜜芥末雞潤餅', note: '微辣', name: '炒雞潤餅3吋', image: '/delicious/2-pic-13.png', product_option_value_id: 140 },
            { text: '蒜味鄉村魚潤餅', name: '酥魚潤餅3吋', image: '/delicious/2-pic-14.png', product_option_value_id: 141 },
            { text: '凱薩烤培根潤餅', name: '培根潤餅3吋', image: '/delicious/2-pic-15.png', product_option_value_id: 142 },
            { text: '媽手老滷肉潤餅', note: '預訂供應', name: '滷肉潤餅3吋', image: '/delicious/2-pic-16.png', product_option_value_id: 143 }
          ]
        },
        {
          title: '湯飲品',
          ...
          // 沒有備註的項目可以只有text字段
          items: [
            { text: '微甜豆漿', name: '微豆', product_option_value_id: 144 },
            { text: '無糖豆漿', name: '無豆', product_option_value_id: 145 },
            { text: '古早味紅茶', name: '紅茶', product_option_value_id: 146 },
            { text: '古早味奶茶', name: '奶茶', product_option_value_id: 147 },
            { text: '季節甜品', note: '(限時升等豆花甜品)', name: '甜湯', product_option_value_id: 149 },
            { text: '季節濃湯', note: '', name: '濃湯', product_option_value_id: 148 }
          ]
        }
      ]
    }
      ...
      listItems: [
        {
          ...
          span: '口味 6 擇 3 或 2',
          items: [
            { text: '薯泥香素鬆潤餅', note: '蛋奶素', name: '薯泥潤餅3吋', image: '/delicious/2-pic-11.png', product_option_value_id: 1612 },
            { text: '千島香酥蝦潤餅', name: '炸蝦潤餅3吋', image: '/delicious/2-pic-12.png', product_option_value_id: 1613 },
            { text: '蜂蜜芥末雞潤餅', note: '微辣', name: '炒雞潤餅3吋', image: '/delicious/2-pic-13.png', product_option_value_id: 1614 },
            { text: '蒜味鄉村魚潤餅', name: '酥魚潤餅3吋', image: '/delicious/2-pic-14.png', product_option_value_id: 1615 },
            { text: '凱薩烤培根潤餅', name: '培根潤餅3吋', image: '/delicious/2-pic-15.png', product_option_value_id: 1616 },
            { text: '媽手老滷肉潤餅', note: '預訂供應', name: '滷肉潤餅3吋', image: '/delicious/2-pic-16.png', product_option_value_id: 1617 }
          ]
        }
      ]
    }
