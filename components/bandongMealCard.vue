      ...
      listItems: [
        {
          ...
          // span: '6擇1',
          items: [
            { text: '招牌便當', name: '虛擬潤餅3吋', image: '/delicious/2-pic-4.png', product_option_value_id: 795 }
      ...
      listItems: [
        {
          ...
          // span: '6擇1',
          items: [
            { text: '雙主餐潤餅便當 - 清蒸嫩雞胸', name: '虛擬潤餅3吋', image: '/delicious/2-pic-6.png', product_option_value_id: 794 }
      ...
      listItems: [
        {
          ...
          // span: '6擇1',
          items: [
            { text: '雙主餐潤餅便當 - 傳香滷雞腿', name: '虛擬潤餅3吋', image: '/delicious/2-pic-g.png', product_option_value_id: 796 }
      ...
      listItems: [
        {
          ...
          // span: '6擇1',
          items: [
            { text: '雙主餐潤餅便當 - 家常厚滷牛', name: '虛擬潤餅3吋', image: '/delicious/2-pic-m.png', product_option_value_id: 797 }
      ...
      listItems: [
        {
          ...
          // span: '6擇1',
          items: [
            { text: '雙主餐潤餅便當 -  法式烤鮭魚', name: '虛擬潤餅3吋', image: '/delicious/2-pic-f.png', product_option_value_id: 832 }
      ...
      listItems: [
        {
          ...
          // span: '6擇1',
          items: [
            { text: '雙主餐潤餅便當 -  法式紅酒牛肉丸', name: '虛擬潤餅3吋', image: '/delicious/2-pic-wine.png', product_option_value_id: 1810 }
