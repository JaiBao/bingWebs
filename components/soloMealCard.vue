            ...
            <div v-for="(listGroup, listGroupIndex) in selectedSlide.dialog.listItems" :key="listGroupIndex" class="titles">
              ...
              <div v-for="(item, itemIndex) in listGroup.items" :key="itemIndex" class="lists">
                <div class="add">
                  ...
                  <q-input class="itemsInput" type="number" min="0" v-model.number="item.quantity" @change="handleInput(listGroupIndex, itemIndex, $event)" />
                  <q-btn class="custom" icon="add" @click="incrementQuantity(listGroupIndex, itemIndex)" round outline />
      ...
      listItems: [
        {
          ...
          span: '+$80',
          items: [
            { text: '薯泥香素鬆潤餅', name: '薯泥潤餅', note: '蛋奶素', image: '/delicious/2-pic-11.png', product_option_value_id: 531, price: 80 },
            { text: '千島香酥蝦潤餅', name: '炸蝦潤餅', image: '/delicious/2-pic-12.png', product_option_value_id: 532, price: 80 },
            { text: '蜂蜜芥末雞潤餅', name: '炒雞潤餅', note: '微辣', image: '/delicious/2-pic-13.png', product_option_value_id: 533, price: 80 },
            { text: '蒜味鄉村魚潤餅', name: '酥魚潤餅', image: '/delicious/2-pic-14.png', product_option_value_id: 534, price: 80 },
            { text: '凱薩烤培根潤餅', name: '培根潤餅', image: '/delicious/2-pic-15.png', product_option_value_id: 535, price: 80 },
            { text: '媽手老滷肉潤餅', note: '預訂供應', name: '滷肉潤餅', image: '/delicious/2-pic-16.png', product_option_value_id: 536, price: 80 }
          ]
        }
      ]
    }
      ...
      listItems: [
        {
          ...
          // 沒有備註的項目可以只有text字段
          items: [
            { text: '微甜豆漿', name: '微豆', product_option_value_id: 493, price: 30 },
            { text: '無糖豆漿', name: '無豆', product_option_value_id: 494, price: 30 },
            { text: '古早味紅茶', name: '紅茶', product_option_value_id: 495, price: 30 },
            { text: '古早味奶茶', name: '奶茶', product_option_value_id: 496, price: 30 },
            { text: '季節濃湯', note: '', name: '濃湯', product_option_value_id: 497, price: 45, span: '+$45' },
            { text: '季節甜品', name: '甜湯', product_option_value_id: 498, price: 45, span: '+$45' }
          ]
        }
      ]
    }
