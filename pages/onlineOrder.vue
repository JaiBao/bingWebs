      ...
      <div class="mealOptions">
        <q-card class="bg-white personCard">
          <div class="cardLeft">
            ...
            <div class="row w-100">
              <p>特殊指示</p>
              <q-input class="w-100 custom-bg-color" v-model="personForm.comment" filled type="textarea" label="新增備註"></q-input>
              <span class="hint">★ 您的備註需求，將由訂餐人員與您電話討論後確認</span>
            </div>
          </div>
          <!-- <div class="cardRight">
            <h6>再次溫馨提醒您：</h6>
    ...
    <q-card class="checkCard">
      <div class="dialogTxt">
        ...
        <div class="row justify-around w-100" id="dialogBtn">
          <q-btn outline class="col-4 fz-1125r" color="pink-8" @click="addOrder">送出</q-btn>
