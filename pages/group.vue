  ...
  <div class="groupProcess" id="booking">
    ...
    <div class="process1" id="process1">
      ...
      <div class="process1Content">
        ...
        <div class="preocess1Img">
          <img loading="lazy" src="/group/Rectangle111.png" alt="米香油飯盒" />
          <h4>米香油飯盒</h4>
        </div>
        <div class="preocess1Img">
      ...
      <div class="process7Content">
        ...
        <div class="process7Text">
          <div class="process7Txt">
            ...
            <p>
              <span class="ops2">● 招牌米香油飯盒</span>
              <span class="ops2">● 主餐米香油飯盒</span>
            </p>
          </div>
        </div>
      </div>

      <button @click="scrollToTarget('riceBox')">查看完整油飯盒系列</button>
    </div>
    <!-- process3 -->
...
const scrollToTarget = targetId => {
  $router.push(`/delicious#${targetId}`)
}
